    ...
    return (
      <div style={{ padding: 48, textAlign: "center" }}>
        ...
        <p style={{ color: "var(--muted)", fontSize: 14 }}>
          Verifique o link recebido ou fale com a equipe responsável.
        </p>
        <div style={{ marginTop: 24 }}>
          <Link to="/" style={{ color: "var(--sage)", fontSize: 13 }}>
            ← Voltar
          </Link>
        </div>
      </div>
  ...
  if (submitted) {
    return (
      <div className="success-screen">
        ...
        <p>
          Agora é com a gente. Estamos preparando cada detalhe para que você se
          sinta realmente bem-vindo(a).
        </p>
      </div>
    );
  }
  ...
  return (
    <>
      <div className="header">
        <div className="header-eyebrow">{loja.nome}</div>
        <h1>
        ...
        <p>
          Este briefing nos ajuda a preparar um momento feito especialmente para
          você — do cardápio à trilha sonora.
        </p>
      </div>
      ...
      <div className="form-container">
        ...
        <div className="section">
          ...
          <div className="field">
            <label>
              ...
              <span className="hint">
                nome, apelido — do jeito que se sentir bem
              </span>
            </label>
            <input
              id="nome"
        ...
        <div className="section">
          ...
          <div className="field">
            <label>
              Preferências de bebida{" "}
              <span className="hint">selecione todas que gostar</span>
            </label>
            <div className="chip-group">
              {BEBIDAS.map((c) => (
                <div
        ...
        <div className="section">
          ...
          <div className="field">
            <label>
              Observações adicionais, preferências especiais ou qualquer detalhe
        ...
        <div className="submit-section">
          ...
          {submitError && (
            <p
              style={{ color: "var(--error)", fontSize: 13, marginBottom: 16 }}
            >
              {submitError}
            </p>
          )}
